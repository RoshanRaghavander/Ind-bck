...
return [
    [
        ...
        'variables' => [
            ...
            [
                'name' => '_APP_LOCALE',
                'description' => 'Set your Indobase\'s locale. By default, the locale is set to \'en\'.',
                'introduction' => '',
                'default' => 'en',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This is the sender name value that will appear on email messages sent to developers from the Indobase console. The default value is: \'Indobase\'. You can use url encoded strings for spaces and special chars.',
                'introduction' => '0.7.0',
                'default' => 'Indobase',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'This is the sender email address that will appear on email messages sent to developers from the Indobase console. The default value is \'noreply@indobase.fun\'. You should choose an email address that is allowed to be used from your SMTP server to avoid the server email ending in the users\' SPAM folders.',
                'introduction' => '0.7.0',
                'default' => 'noreply@indobase.fun',
                'required' => false,
                'question' => '',
                'filter' => ''
            ],
            [
                ...
                'description' => 'This is the sender email address that will appear in the generated specs. The default value is \'team@indobase.fun\'.',
                'introduction' => '1.6.0',
                'default' => 'team@indobase.fun',
                'required' => false,
                'question' => '',
                'filter' => ''
            ],
