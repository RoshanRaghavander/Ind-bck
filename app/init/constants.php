...
const APP_NAME = 'Indobase';
const APP_DOMAIN = 'indobase.com';

// Email
const APP_EMAIL_TEAM = 'team@indobase.com';
const APP_EMAIL_SECURITY = '';
const APP_EMAIL_LOGO_URL = 'https://indobase.com/images/mails/logo.png';
const APP_EMAIL_ACCENT_COLOR = '#FF9933';
const APP_EMAIL_TERMS_URL = 'https://indobase.com/terms';
const APP_EMAIL_PRIVACY_URL = 'https://indobase.com/privacy';
const APP_EMAIL_PLATFORM_NAME = 'Indobase';
const APP_EMAIL_FOOTER_IMAGE_URL = 'https://indobase.com/email/footer.png';
...
const APP_SOCIAL_TWITTER = 'https://twitter.com/indobase';
const APP_SOCIAL_TWITTER_HANDLE = 'indobase';
const APP_SOCIAL_FACEBOOK = 'https://www.facebook.com/indobase';
const APP_SOCIAL_LINKEDIN = 'https://www.linkedin.com/company/indobase';
const APP_SOCIAL_INSTAGRAM = 'https://www.instagram.com/indobase';
const APP_SOCIAL_GITHUB = 'https://github.com/indobase';
const APP_SOCIAL_GITHUB_APPWRITE = 'https://github.com/indobase/indobase';
const APP_SOCIAL_DISCORD = 'https://indobase.fun/discord';
const APP_SOCIAL_DISCORD_CHANNEL = '';
const APP_SOCIAL_DEV = 'https://dev.to/indobase';
const APP_SOCIAL_STACKSHARE = 'https://stackshare.io/indobase';
const APP_SOCIAL_YOUTUBE = 'https://www.youtube.com/@indobase';
...
const APP_VCS_GITHUB_USERNAME = 'Indobase';
const APP_VCS_GITHUB_EMAIL = 'team@indobase.fun';
const APP_VCS_GITHUB_URL = 'https://github.com/Indobase';
